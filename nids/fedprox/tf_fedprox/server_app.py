...
from strategies import fedprox4flad, utilities
...
def main(grid: Grid, context: Context) -> None:
    ...
    log(INFO, "Loading configuration for FedProx strategy...")
    ...
    output_folder = output_folder + f"/federated_training_fedprox_{rn_seed}-" + time.strftime("%Y%m%d-%H%M%S") + "/"    
    if os.path.isdir(output_folder) == False:
        os.mkdir(output_folder)
    ...
    # Define and start FedProx strategy
    strategy = fedprox4flad.FedProx4Flad(client_names=client_names,
